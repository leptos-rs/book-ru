...
Возможно, вы захотите потратить несколько минут и настроить окружение, чтобы оптимизировать ваш процесс разработки,
...
Используя `console_error_panic_hook` вы получите настоящую трассировку стека Rust с номерами строк в вашем Rust коде.
...
## 3) Настройка `leptosfmt` с анализатором Rust (необязательно)
